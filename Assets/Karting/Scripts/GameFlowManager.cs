...
public class GameFlowManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gameModeController;
    [SerializeField] private ObjectiveReachTargets objectiveReachTargets;
    ...
    IEnumerator GameStartRoutine()
    {
        ...
        yield return new WaitUntil(() => gameModeController.GetComponent<GameModeController>().getSelectionFinisched() == true);

        //m_TimeManager.enabled = true;
    ...
    void Update()
    {
        ...
        {
            if (ObjectiveReachTargets.playerWin != 0)
                EndGame(ObjectiveReachTargets.playerWin);
        }
    }

    void EndGame(int playerWin)
    {
